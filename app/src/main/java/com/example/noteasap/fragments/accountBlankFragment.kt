 ...
 * Use the [accountBlankFragment.newInstance] factory method to
...
class accountBlankFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        account.setOnClickListener(){
            Toast.makeText(context, "This is personal page", Toast.LENGTH_SHORT).show()
        }
    }
    companion object {
        /**
         ...
         * @return A new instance of fragment accountBlankFragment.
         */
